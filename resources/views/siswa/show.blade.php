...
<div class="row">
	...
	<div class="panel-panel-primary">
		<div class="panel-headling">Data Siswa
		...
		<div class="panel-body">
			<form >
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="b" value="{{$anak->orangtua->nama_ayah}} dan {{$siswa->orangtua->nama_ibu}}" readonly="">
					</input>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<textarea class="form-control" rows="10" name="d" required="" readonly="">{{$siswa->alamat}}</textarea>
				</div>
			</form>
		</div>
	</div>
